...
int main()
{
	...
	double pctLikeInPerson = 500 * likeInPerson / numberSurveyed;   //mulitply by the wrong number to get percentage
	double pctLikeAtHome = 500 * likeAtHome / numberSurveyed;       //mulitply by the wrong number to get percentage
